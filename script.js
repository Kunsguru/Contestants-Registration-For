document.querySelector('.read-more-btn').addEventListener('click', function() {
        ...
        function handleRegistrationClick() {
            ...
            document.getElementById('contestant-number').value = formattedDate;
        }
        ...
        function handleFormSubmit(event) {
            ...
            if (![2250, 5750, 16000].includes(paymentAmount)) {
            ...
            const emailBody = `
                ...
                Contestant Number: ${formData.get('contestant-number')}
        ...
        function goBackHome() {
            window.location.href = 'https://shullian-stitches-and-couture.onrender.com/';
        }
